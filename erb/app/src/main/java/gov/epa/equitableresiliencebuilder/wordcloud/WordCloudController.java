package gov.epa.equitableresiliencebuilder.wordcloud;
...
//		// --------------------
//		mergeTableColumn.setCellValueFactory(new PropertyValueFactory<WordCloudItem, Boolean>("merge"));
//		mergeTableColumn
...
//				});
//		// ---------------
//		phraseTableColumn.setCellValueFactory(new PropertyValueFactory<WordCloudItem, String>("phrase"));
//		// ---------------
//		plusTableColumn
//				.setCellFactory(new Callback<TableColumn<WordCloudItem, Boolean>, TableCell<WordCloudItem, Boolean>>() {
//					@Override
...
//				});
//		// ---------------
//		countTableColumn.setCellValueFactory(new PropertyValueFactory<WordCloudItem, String>("count"));
//		// ----------------
